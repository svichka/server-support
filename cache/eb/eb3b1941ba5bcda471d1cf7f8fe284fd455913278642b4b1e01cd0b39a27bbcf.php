            ...
            <div class=\"services-item\">
                <a href=\"/\" class=\"services-item-link\">
                    ...
                    <p>
                        ...
                        и управление  IT системами любой сложности. Кластеры, Облака, HighLoad.
                    </p>
                </a>
            </div>
            <div class=\"services-item\">
            ...
            <div class=\"services-item\">
                <a href=\"/\" class=\"services-item-link\">
                    ...
                    <p>
                        ...
                        и  автоматизация процессов  CI/CD:
        ...
        <div class=\"how-items\">
            ...
            <a href=\"/\" class=\"how-item\">
                ...
                <p>
                    ...
                    и ITIL. Поэтому мы никогда ничего не теряем,
    ...
    <div class=\"who-container\">
        ...
        <div class=\"who-content\">
            ...
            <div class=\"who-content-text\">
                ...
                <p>Нас объединяет искренняя любовь к нашему делу и личной <br>свободе, поэтому:</p>

                <ul>
                    <li>У нас нет офиса, в привычном понимании этого слова, поскольку он нам не нужен.</li>
                    <li>Все мы начали карьеру в начале 2000х</li>
                    <li>У нас нет сотрудников младше 35 лет.</li>
                </ul>
            </div>
        </div>
    </div>
...
Только этот факт говорит многое о профессионализме команды, но добавлю еще, что совместно с командой “поддержка серверов” нами была разработана и внедрена автоматизированная система сквозной аналитики по продажам, товарообороту и складскому учету с элементами BIGdata, которая позволила не только сэкономить и оптимизировать логистику и производство, но и посмотреть на бизнес с новых сторон.
                        </p>
                    </div>
                </div>
            </div>
...
Благодаря профессионализму команды Server-Support все сайты нашей компании отлично работают и постоянно доступны.<br> 
Отдельно хочется отметить, что ребята всегда готовы подключится к решению нетиповых задач, предоставить экспертную оценку и альтернативу в любых вопросах, где это требуется.
...
Стоимость оговаривается во всех случаях до начала работ и не меняется, если не меняются условия задачи/проекта.</br>
</p>

<h2>3 000 ₽<br>за час</h2>
</div>
            </div>
            ...
            <div class=\"services-item\">
                <div class=\"services-item-link\">
                    ...
                    Включает:
                    <ul>
                        <li>Анализ ваших текущих целей и задач, формулировку бизнес-требований</li>
                            <li>Разработку архитектуры и ее техническое и экономическое обоснование</li>
                                <li>Настройку операционной системы, служб и ПО</li>
                                    <li>Настройка безопасности</li>
                                        <li>Настройка резервного копирования</li>
                                            <li>Подключение к системе мониторинга</li>

                    </ul><br>
                    <h2>20 000 ₽<br>за сервер</h2>
                </div>
            </div>
            ...
            <div class=\"services-item\">
                <div class=\"services-item-link\">
                    ...
                    Включает:
                    <ul>
                         <li>Выполнение заявок на обслуживание</li>
                         <li>Мониторинг работоспособности серверов и сервисов</li>
                            <li>Профилактику сбоев</li>
                        <li>Обновление ПО</li>
                            <li>100 Гб удаленных бэкапов</li> 
                        <li>Дополнительные работы 2000 ₽ за час</li>
                    </ul>
<br><br><br>
<h2>10 000 ₽<br>за сервер в месяц</h2>
